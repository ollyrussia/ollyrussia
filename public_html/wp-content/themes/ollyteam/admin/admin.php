                    ...
                    <table class="table table-vcenter table-mobile-md card-table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td class="text-muted" data-label="Sum">
                            {{ selectedSession.sum }}
                          </td>                          
                          <td>
      ...
      <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
			...
			<div class="mb-3">
				<label class="form-label">Кому добавляем</label>
				<select name="therapist" class="form-select" aria-label="Default select example">
									<?
										$users = get_users('role=psychologist&orderby=meta_value&meta_key=last_name' );
			...
			<div class="form-selectgroup-boxes row mb-3">
             ...
             <!-- <div class="col-lg-4">
                <label class="form-selectgroup-item">
                  <input type="radio" name="type" value="Психосоматика" class="form-selectgroup-input">
                  <span class="form-selectgroup-label d-flex align-items-center p-3">
                    <span class="me-3">
                      <span class="form-selectgroup-check"></span>
                    </span>
