<?
/*
 * Template name: Olly - главная / дубль
          ...
          <div class="ot-intro__info col-12 col-md-6 d-flex flex-column align-items-center align-items-md-start justify-content-between">
            ...
            <div class="ot-intro__info-items d-none d-md-flex justify-content-between">
              <div class="ot-intro__info-item d-flex flex-column">
                ...
                <span class="ot-intro__info-item-title">Психолога-практика<br> в команде</span>
              </div>
              <div class="ot-intro__info-item d-flex flex-column">
          ...
          <div class="col-12 col-lg-4 col-xl-6">
            <div class="ot-our-psychologists__slider">
              ...
              <div class="ot-our-psychologists__team-text d-flex flex-column flex-md-row align-items-center">
                ...
                <span>психолога-практика в команде</span>
              </div>
        ...
        <div class="ot-psychologist-selection__categories">
          ...
          <div class="d-flex align-items-center justify-content-center flex-wrap flex-sm-nowrap">
            <div class="ot-psychologist-selection__btn-wrp d-flex flex-column align-items-center">
              <button id="base_btn" data-toggle="modal" data-target="#calendar" class="ot-psychologist-selection__btn-type ot-btn">Психология</button>
            </div>          	
            <div class="ot-psychologist-selection__btn-wrp d-flex flex-column align-items-center">
              <button id="psy_btn" data-toggle="modal" data-target="#calendar" class="ot-psychologist-selection__btn-type ot-btn" style="background:#5ab3c9;color:#fff">Психосоматика</button>
            </div>
            <div class="ot-psychologist-selection__btn-wrp d-flex flex-column align-items-center">
        ...
        <div class="ot-psychologist-selection__categories">
          ...
          <div class="d-flex align-items-center justify-content-center flex-wrap flex-sm-nowrap">
            <div class="ot-psychologist-selection__btn-wrp d-flex flex-column align-items-center">
              ...
              <span
                class="ot-psychologist-selection__category-price-range d-none d-md-block">Стоимость консультации от 6000 до 10000 руб</span>
            </div>          	
            <div class="ot-psychologist-selection__btn-wrp d-flex flex-column align-items-center">
              <button class="ot-psychologist-selection__btn-category ot-btn" data-swiper-class="top">1 категория</button>
              <span
                class="ot-psychologist-selection__category-price-range d-none d-md-block">Стоимость консультации от 4000 руб</span>
            </div>
            <div class="ot-psychologist-selection__btn-wrp d-flex flex-column align-items-center">
						...
						echo '
						         <div class="swiper-slide ot-psychologist-card ot-psychologist-card_full d-flex flex-row flex-sm-column '.$category.'">
					                  ...
					                  <div class="ot-psychologist-card__info d-flex flex-column align-items-center">
					                    ...
					                    <a href="'.home_url('/').get_the_author_meta('url_name',$user->ID).'" class="ot-psychologist-card__btn ot-btn ot-btn_main ot-btn_gradient-primary">Записаться</a>
					                  </div>
				                </div>
						';
					}
              ...
              <div class="ot-faq__collapse-item-main">
                ...
                <div class="ot-faq__collapse-item-content collapse" id="faq-price">
					...
					<ul>
						...
						<li>1 категория - 4000 ₽</li>
						<li>Высшая категория - 6000-10000 ₽</li>
					</ul>
					...
					<ul>
						...
						<li>Проработка панических атак 12000-15000 ₽</li>
					</ul>					
          ...
          <div class="d-flex flex-column flex-md-row w-100">
            <div class="ot-modal-calendar__calendar">
              <div class="ot-modal-calendar__category-wrp d-flex flex-column">
                <p class="ot-modal-calendar__category-text">Выберите категорию консультаций:</p>
                <div class="ot-modal-calendar__category-select-wrp">
                  <select name="type_calendar" class="ot-modal-calendar__category-select">
            ...
            <div class="ot-modal-calendar__data-content d-flex flex-column">
              ...
              <template v-else>
			      ...
			      <div class="d-flex align-items-center">
			        ...
			        <span class="mx-2">—</span>-->
			        <span class="text-left" style="font-size: 14px;">Первичная консультация по психосоматике, включает в себя разбор цепочки, продолжительность: 2,5-3 часа</span>
			      </div>
            	</div>
              </template>
              ...
              <template v-else>
	              <div class="ot-modal-calendar__sessions-list d-flex flex-column flex-grow-1 overflow-auto">
	                <div class="ot-modal-calendar__list-item d-flex flex-column" v-for="item of dateSessions">
	                  ...
	                  <span class="ot-modal-calendar__price">Цена за сессию: {{ item.price }} рублей</span>
      ...
      <div class="modal-body">
        ...
        <form id="" action="<?= admin_url('admin-post.php'); ?>" method="POST">
          ...
          <label class="ot-check mb-3" for="cart-terms">
            ...
            <span class="ot-check__mark"></span>
            <span class="ot-check__text d-flex flex-column">
                <span>Ознакомлен/ознакомлена и согласен/согласна с тем, что в случае отмены консультации более, чем за 24 часа, возврат денежных средств осуществляется с удержанием орг.взноса в размере 20% от суммы. При отмене консультации менее, чем за 24 часа - оплата не возвращается.</span>
              </span>
          </label>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form id="inPersonForm" method="POST">
		  ...
		  <div class="form-group">
		    <label for="in-therapist">К кому вы бы хотели попасть на прием</label>
		    <select class="form-control" id="in-therapist" name="therapist">
		      <?
					foreach ($users as $user) {
  ...
  $(document).ready(function () {
	...
	function load_calendar()
	{
	    ...
	    $(".my-calendar").zabuto_calendar({
	      ...
	      ajax: { url: "https://ollyteam.ru/zabuto?type="+$('[name="type_calendar"]').val() },
	      nav_icon: {
